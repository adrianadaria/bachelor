            ...
            <div className="form_style">
                ...
                <form onSubmit={this.onSave} className="update_form">
                    ...
                    <label><h5>Number</h5></label>
                        <input type="text" value={this.state.number} required readOnly/>
                    <label><h5>Name</h5></label>
                        <input type="text" value={this.state.name} required onChange={this.onNameChange} />
                    <label><h5>Price (DKK)</h5></label>
                        <input type="number" step="0.01" value={this.state.price} required onChange={this.onPriceChange}/>
                    <label><h5>Group</h5></label>
                        <input type="number" className='form-control' value={this.state.group} required onChange={this.onGroupChange}/>
